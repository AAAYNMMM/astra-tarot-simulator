...
assert.match(application, /const deck = Object\.freeze\(\[\.\.\.majorCards, \.\.\.minorCards\]\);/);
assert.match(application, /const spreads = SPREADS;/);
assert.equal(application.includes("TarotData"), false);
