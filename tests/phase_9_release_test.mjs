...
assert.equal(matrix.release, "2.0.0");
...
assert.equal(release.release, "2.0.0");
assert.match(release.releaseId, /^2\.0\.0-/);
assert.equal(read("src/config/version.js").includes('APP_VERSION = "2.0.0"'), true);
