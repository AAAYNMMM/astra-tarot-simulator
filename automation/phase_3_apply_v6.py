...
gate_path = root / "tests/phase_2_gate_test.mjs"
gate = gate_path.read_text(encoding="utf-8")
old = 'assert.match(progress,/唯一下一任务 \\| `QP-003A`/);'
if gate.count(old) != 1:
    raise RuntimeError("Phase 2 NEXT assertion anchor mismatch")
gate_path.write_text(gate.replace(old, "", 1), encoding="utf-8", newline="\n")
