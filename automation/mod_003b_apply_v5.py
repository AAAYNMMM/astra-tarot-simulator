#!/usr/bin/env python3
"""Run MOD-003B with repaired migration scopes and Python module footer."""
...
replacements = [
    ...
    (
        ...
        '    lifecycle_body, module_footer = lifecycle_method.split("\\n\\nif __name__ == \\"__main__\\":", 1)\n'
        '    lifecycle_body = "\\n".join(f"    {line}" if line else line for line in lifecycle_body.splitlines())\n'
        '    lifecycle_method = lifecycle_body + "\\n\\nif __name__ == \\"__main__\\":" + module_footer\n'
        '    python_test = regex_once(python_test, lifecycle_pattern, lifecycle_method, "python lifecycle method")\n',
        "lifecycle method and footer indentation",
    ),
]
